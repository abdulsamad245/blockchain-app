  ...
  return (
    ...
    >
      <rect
        ...
        id="border"
      />
      <text x="500" y="100" text-anchor="middle" fill="blue" id="bodyTitle">
        Certificate
      </text>
      <text x="500" y="125" text-anchor="middle" fill="white" id="bodySubTitle">
        of
      </text>
      <line x1="250" y1="260" x2="750" y2="260" id="titleUnderLine" />
      <text x="500" y="250" text-anchor="middle" fill="white" id="title">
        {title}
      </text>
      <text
        x="500"
